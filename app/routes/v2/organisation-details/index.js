...
module.exports = [
  {
    ...
    options: {
      handler: async (request, h) => {
        ...
        const organisation = await getOrganisation(applyJourney.selectedSbi)
        ...
        return h.view('v2/organisation-details/organisation-details', { sbi: applyJourney.selectedSbi, name, address })
      }
    }
  }
]
